                   ...
                   <?php 
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;">
                        ...
                        <a href="<?php echo base_url('admin/user/hapus/'.$u->nip);?>" onclick="return confirm('Anda yakin?')" ><span class="glyphicon glyphicon-trash" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Hapus"></span></a>
                      </td>
                    </tr>
                    <?php } ?>
            ...
            <div class="modal-content">
              ...
              <div class="box-body">
                ...
                <select class="form-control select2" name="level" style="width: 100%;" required="" >
                            ...
                            <option>---Pilih---</option>
                            <option value="1">Administrator Sekretariat</option>
                  ...
                  <label for="level" class="col-sm-2 control-label">Level</label>
                    <div class="col-sm-8">
                          <select class="form-control select2" name="level" style="width: 100%;">
                                      ...
                                      <option <?php if ($u->level == '1') { echo 'selected'; } ?> value="1">Administrator Sekretariat</option>
                                      <option <?php if ($u->level == '2') { echo 'selected'; } ?> value="2">Kepala Dinas </option>
