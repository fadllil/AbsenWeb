      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tambah" style="margin: 15px"> <i class="fa fa-plus"></i> Tambah Absen Siang</button>
                ...
                <tbody>
                   <?php 
                    ...
                    <tr>
                      ...
                      <td><?php if ($u->absen_siang == '1') {
                                  echo "Hadir";
                                }elseif ($u->absen_siang == '2') {
                                  echo "Sakit";
                                }elseif ($u->absen_siang == '3') {
                                  echo "Izin";
                                }elseif ($u->absen_siang == '4') {
                                  echo "Alpha";
                                }elseif ($u->absen_siang == '5') {
                                  echo "Dinas Luar";
                                }elseif ($u->absen_siang == '6') {
                                  echo "Cuti";
                                }
                      ?></td>
                      
                      <td style="text-align: center;">
                        <a href="<?php echo base_url('admin/cabsen_siang/hapus/'.$u->id_absen);?>" onclick="return confirm('Anda yakin?')" ><span class="glyphicon glyphicon-trash" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Hapus"></span></a>
                      </td>
                    </tr>
                    <?php } ?>
    ...
    <div class="modal fade" id="tambah">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form class="form-horizontal" action="<?php echo base_url('admin/cabsen_siang/tambah'); ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="nip" id="absen_pagi" style="width: 100%;" required="">
                            ...
                            foreach ($pegawai as $p) { ?>
                                <?php $v=TRUE;  for($i=0;$i<count($siang);$i++){
