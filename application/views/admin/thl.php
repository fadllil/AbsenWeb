                   ...
                   <?php 
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;">
                        ...
                        <a href="<?php echo base_url('admin/thl/hapus/'.$u->nip);?>" onclick="return confirm('Anda yakin?')" ><span class="glyphicon glyphicon-trash" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Hapus"></span></a>
                      </td>
                    </tr>
                    <?php } ?>
    ...
    <div class="modal fade" id="tambah">
          <div class="modal-dialog" style="width:68%" >
            <div class="modal-content">
              ...
              <form class="form-horizontal" action="<?php echo base_url('admin/thl/tambah'); ?>" method="post">
              <div class="box-body">
        ...
        <div class="modal fade" id="edit<?php echo $u->nip?>" tabindex="-1" role="dialog" aria-hidden="true" aria-labelledby="myModalLabel2">
          <div class="modal-dialog modal-ig" style="width:68%" >
            <div class="modal-content">
              ...
              <form class="form-horizontal form-label-left" action="<?php echo base_url('admin/thl/update'); ?>" method="post" >
              <div class="box-body" >
