              ...
              foreach ($pegawai as $u) {
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                    ...
                    <a href="<?php echo base_url('umum/cpns/hapus/' . $u->nip); ?>" onclick="return confirm('Anda yakin?')"><span class="glyphicon glyphicon-trash" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Hapus"></span></a>
                  </td>
                </tr>
              <?php } ?>
            </tbody>
...
<div class="modal fade" id="tambah">
  <div class="modal-dialog" style="width:68%">
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="<?php echo base_url('umum/cpns/tambah'); ?>" method="post">
        <div class="box-body">

          <div class="form-group">
            <label class="col-sm-2 control-label">NIP</label>
            <div class="col-sm-8">
              <input type="number" max="999999999999999999" class="form-control" placeholder="NIP" name="nip" required="">
            </div>
          </div>
          ...
          <div class="form-group">
            <label for="no_hp" class="col-sm-2 control-label">Golongan</label>
            <div class="col-sm-8">
  ...
  <div class="modal fade" id="edit<?php echo $u->nip ?>" tabindex="-1" role="dialog" aria-hidden="true" aria-labelledby="myModalLabel2">
    <div class="modal-dialog modal-ig" style="width:68%">
      <div class="modal-content">
        ...
        <form class="form-horizontal form-label-left" action="<?php echo base_url('umum/cpns/update'); ?>" method="post">
          <div class="box-body">
            <div class="form-group">
