                ...
                if ($d == $u->tgl_absen) {
                  ...
                  <tr>
                    ...
                    <td style="text-align: center;">
                      <a href="<?php echo base_url('umum/cabsen_pagi/hapus/' . $u->id_absen); ?>" onclick="return confirm('Anda yakin?')"><span class="glyphicon glyphicon-trash" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Hapus"></span></a>
                    </td>
                  </tr>
                <?php }
            } ?>
...
<div class="modal fade" id="tambah">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="<?php echo base_url('umum/cabsen_pagi/tambah'); ?>" method="post">
        <div class="box-body">
